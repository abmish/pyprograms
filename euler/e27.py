...
n = 40, 402 + 40 + 41 = 40(40 + 1) + 41 is divisible by 41, and certainly when n = 41, 41^2 + 41 + 41 is clearly divisible by 41.
...
for a in xrange(-999, 1000):
    for b in xrange(max(2, 1-a), 1000):
        n, count = 0, 0
        while True:
            v = n*n + a*n + b
            primelib._refresh(v)
            if primelib.isprime(v): count = count + 1
            else: break
            n = n + 1
        if count > max_pair[2]:
            max_pair = (a,b,count)
